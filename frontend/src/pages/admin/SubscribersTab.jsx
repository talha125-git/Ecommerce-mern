  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {/* Total Subscribers */}
        <div className="bg-white border border-gray-200 rounded-2xl p-4.5 shadow-xs flex items-center justify-between">
          <div>
            ...
            <p className="text-[11px] text-gray-400 mt-0.5">All captured emails</p>
          </div>
      ...
      {statusMsg.text && (
        <div
          className={`p-3.5 rounded-2xl text-xs font-semibold border flex items-center justify-between gap-3 ${
                    ...
                    <tr key={sub._id} className="hover:bg-gray-50/80 transition">
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-9 h-9 rounded-xl font-bold flex items-center justify-center text-xs shadow-xs uppercase shrink-0 ${
                              isVerified
